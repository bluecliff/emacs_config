...
(defun color-theme-lijsf ()
  ...
  (color-theme-install
   '(color-theme-lijsf
      ...
      (border-color . "#32353e")
      (cursor-color . "#c0c4b1")
      (foreground-color . "#cfd4a0")
      (mouse-color . "black"))
     (fringe ((t (:background "#32353e"))))
     (mode-line ((t (:foreground "#aeae9e" :background "#52554e"))))
     (region ((t (:background "#52544f"))))
     (font-lock-builtin-face ((t (:foreground "#64a1e3"))))
     (font-lock-comment-face ((t (:foreground "#888a85"))))
     (font-lock-function-name-face ((t (:foreground "#c7b643"))))
     (font-lock-keyword-face ((t (:foreground "#6f98c3"))))
     (font-lock-string-face ((t (:foreground "#904788"))))
     (font-lock-type-face ((t (:foreground"#6aab2b"))))
     (font-lock-constant-face ((t (:foreground "#a87a1a"))))
     (font-lock-variable-name-face ((t (:foreground "#919150"))))
     (minibuffer-prompt ((t (:foreground "#8bacd0" :bold t))))
     (font-lock-warning-face ((t (:foreground "red" :bold t))))
     )))
"(provide 'color-theme-lijsf)"
